...
class ActivationReference(TorchDispatchMode):
    def __init__(self,weights):
        ...
        if not hasattr(weights.lib, "flash_memory_activation_quant"):
            raise RuntimeError("Configured bridge lacks flash_memory_activation_quant; rebuild the matching activation-reference bridge")
